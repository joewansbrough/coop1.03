...
import { useUser, useTenants } from '../../../hooks/useCoopData';
...
export default function AdminWaitlistPage() {
  ...
  return (
    <div className="space-y-6 pb-12 transition-colors duration-200">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-white/5 overflow-hidden transition-colors duration-200 shadow-sm">
