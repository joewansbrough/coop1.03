...
import { useUser, useUnits, useTenants, useMaintenance, useAnnouncements, useEvents } from '../hooks/useCoopData';
import { MOCK_ANNOUNCEMENTS, MOCK_UNITS, MOCK_TENANTS, MOCK_REQUESTS, MOCK_EVENTS } from '../constants';
    ...
    return (
      <div className="space-y-6 lg:space-y-8 max-w-7xl mx-auto animate-in fade-in duration-500 transition-colors duration-200">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/maintenance" className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-3 active:scale-95 shadow-lg shadow-emerald-500/20">
                  <i className="fa-solid fa-wrench"></i> Service Queue
                </Link>
                <Link href="/admin/reports" className="bg-white/5 hover:bg-white/10 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all backdrop-blur-xl border border-white/10 flex items-center justify-center gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          <Link href="/admin/units" className="block hover:scale-[1.02] active:scale-95 transition-all group">
          ...
          <Link href="/admin/tenants" className="block hover:scale-[1.02] active:scale-95 transition-all group">
          ...
          <Link href="/maintenance" className="block hover:scale-[1.02] active:scale-95 transition-all group">
          ...
          <Link href="/admin/waitlist" className="block hover:scale-[1.02] active:scale-95 transition-all group">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-4 lg:p-8 rounded-3xl border border-slate-200 dark:border-white/5 overflow-hidden">
            ...
            {units.length > 0 ? (
              ...
              <div className="py-20 text-center border-2 border-dashed border-slate-100 dark:border-white/5 rounded-3xl">
                ...
                <Link href="/admin/units" className="mt-4 inline-flex items-center gap-2 text-emerald-600 font-black text-[10px] uppercase tracking-widest hover:underline">
      ...
      <div className="relative overflow-hidden bg-slate-900 dark:bg-slate-950 rounded-[2.5rem] p-8 lg:p-12 text-white border border-white/5">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/maintenance" className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-3 active:scale-95">
                <i className="fa-solid fa-wrench"></i> Report Issue
              </Link>
              <Link href="/documents" className="bg-white/5 hover:bg-white/10 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all backdrop-blur-xl border border-white/10 flex items-center justify-center gap-3">
          ...
          {!isAdmin && userOpenRequests.length > 0 && (
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-white/5 p-8 shadow-sm">
              <div className="flex justify-between items-center mb-8 border-b border-slate-50 dark:border-white/5 pb-6">
                ...
                <Link href="/maintenance" className="text-xs font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest hover:underline">View All</Link>
              </div>
            ...
            {recentAnnouncements.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {recentAnnouncements.map(ann => (
                  <Link href={`/announcements/${ann.id}`} key={ann.id} className="group flex flex-col h-full bg-slate-50/50 dark:bg-slate-800/30 p-6 rounded-3xl border border-slate-100 dark:border-white/5 hover:bg-white dark:hover:bg-slate-800 hover:border-emerald-200 dark:hover:border-emerald-500/30 transition-all">
