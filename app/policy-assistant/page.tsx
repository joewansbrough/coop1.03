...
import { Bot, Send, User, Sparkles, Shield, MessageSquare, Info } from 'lucide-react';
import { geminiService } from '../../services/geminiService';
import { useUser, useDocuments, useAnnouncements } from '../../hooks/useCoopData';
...
export default function PolicyAssistantPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100vh-8rem)] flex flex-col gap-6 animate-in fade-in duration-700 pb-12 transition-colors duration-200">
      {/* Header Section */}
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-0">
        ...
        {/* Main Chat Interface */}
        <div className="lg:col-span-3 flex flex-col bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-white/5 overflow-hidden shadow-sm">
          {/* Chat Messages */}
          ...
          <div className="p-6 bg-slate-50/50 dark:bg-slate-950/50 border-t border-slate-100 dark:border-white/5">
            <form onSubmit={handleSend} className="relative flex items-center gap-3">
              ...
              <button
                type="submit"
                disabled={!input.trim() || isLoading || user.isGuest}
