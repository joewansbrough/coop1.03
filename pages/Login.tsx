  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="bg-slate-900 p-12 lg:p-16 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h1 className="text-2xl font-black tracking-tight"><span class="text-slate-900 dark:text-white">coop</span><span class="text-teal-600 dark:text-teal-400">HUB</span><span class="text-slate-900 dark:text-white"> BC</span></h1>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 relative z-10">
            <p className="text-slate-400 text-xs font-medium leading-relaxed">
              <span class="text-slate-900 dark:text-white">coop</span><span class="text-teal-600 dark:text-teal-400">HUB</span><span class="text-slate-900 dark:text-white"> BC</span> is a secure platform designed specifically for British Columbia housing co-operatives.
      ...
      <div className="mt-8 text-center text-slate-400 text-[10px] font-black uppercase tracking-widest">
        &copy; 2026 <span class="text-slate-900 dark:text-white">coop</span><span class="text-teal-600 dark:text-teal-400">HUB</span><span class="text-slate-900 dark:text-white"> BC</span> &bull; All Rights Reserved
      </div>
    </div>
  );
};
