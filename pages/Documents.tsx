          ...
          {isAdmin && (
            <button 
              ...
              className={`w-full sm:w-auto px-6 py-3 rounded-xl font-black text-xs uppercase flex items-center justify-center gap-2 active:scale-95 transition-all ${
                showUpload ? 'bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-300' : 'bg-emerald-600 text-white hover:bg-emerald-700'
              }`}
            >
            ...
            {isUploading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div 
                  ...
                  className={`bg-slate-50 dark:bg-slate-950/50 border-2 border-dashed rounded-3xl p-10 flex flex-col items-center justify-center text-center group transition-all cursor-pointer ${
                    selectedFile ? 'border-emerald-500 bg-emerald-50/10' : 'border-slate-200 dark:border-white/10 hover:border-emerald-400'
                  }`}
                >
                  <input 
                    type="file" 
            ...
            >
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {doc.tags.map(tag => (
                    <button 
                      ...
                      className={`text-[8px] font-black px-2 py-0.5 rounded uppercase tracking-tighter transition-all ${
                        filter === tag 
              ...
              <div className="mt-auto flex items-center justify-between pt-4 border-t border-slate-50 dark:border-white/5">
                <button 
                  ...
                  className={`text-[9px] font-black px-2 py-1 rounded uppercase tracking-widest border transition-all ${
                    filter === doc.category
