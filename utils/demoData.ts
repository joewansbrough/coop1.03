...
export const MOCK_UNITS: Unit[] = [
  ...
  { id: 'u3', number: '103', type: '2BR', floor: 1, status: 'Occupied', currentTenantId: 't3' },
  { id: 'u4', number: '104', type: '3BR', floor: 1, status: 'Occupied', currentTenantId: 't4' },
  { id: 'u5', number: '105', type: '1BR', floor: 1, status: 'Vacant', currentTenantId: null },
  { id: 'u6', number: '106', type: '2BR', floor: 1, status: 'Occupied', currentTenantId: 't5' },
  { id: 'u7', number: '107', type: '1BR', floor: 1, status: 'Occupied', currentTenantId: 't6' },
  { id: 'u8', number: '108', type: '2BR', floor: 1, status: 'Occupied', currentTenantId: 't7' },
  { id: 'u9', number: '109', type: '1BR', floor: 1, status: 'Occupied', currentTenantId: 't8' },
  { id: 'u10', number: '201', type: '2BR', floor: 2, status: 'Occupied', currentTenantId: 't9' },
  { id: 'u11', number: '202', type: '3BR', floor: 2, status: 'Occupied', currentTenantId: 't10' },
  { id: 'u12', number: '203', type: '1BR', floor: 2, status: 'Occupied', currentTenantId: 't11' },
  { id: 'u13', number: '204', type: '2BR', floor: 2, status: 'Maintenance', currentTenantId: null },
  { id: 'u14', number: '205', type: '3BR', floor: 2, status: 'Occupied', currentTenantId: 't12' },
  { id: 'u15', number: '206', type: '2BR', floor: 2, status: 'Occupied', currentTenantId: 't13' },
  { id: 'u16', number: '207', type: '1BR', floor: 2, status: 'Occupied', currentTenantId: 't14' },
  { id: 'u17', number: '208', type: '1BR', floor: 2, status: 'Occupied', currentTenantId: 't15' },
  { id: 'u18', number: '209', type: '2BR', floor: 2, status: 'Occupied', currentTenantId: 't16' },
  { id: 'u19', number: '301', type: '3BR', floor: 3, status: 'Occupied', currentTenantId: 't17' },
  { id: 'u20', number: '302', type: '2BR', floor: 3, status: 'Occupied', currentTenantId: 't18' },
];
...
export const MOCK_TENANTS: Tenant[] = [
  ...
  { id: 't3', firstName: 'Priya', lastName: 'Sharma', email: 'priya.sharma@email.com', phone: '250-555-0103', status: 'Current', unitId: 'u3', role: 'MEMBER', startDate: '2021-01-10' },
  { id: 't4', firstName: 'Robert', lastName: 'Tremblay', email: 'robert.tremblay@email.com', phone: '250-555-0104', status: 'Current', unitId: 'u4', role: 'MEMBER', startDate: '2018-09-01' },
  { id: 't5', firstName: 'Susan', lastName: 'Tremblay', email: 'susan.tremblay@email.com', phone: '250-555-0105', status: 'Current', unitId: 'u6', role: 'MEMBER', startDate: '2018-09-01' },
  { id: 't6', firstName: 'James', lastName: 'Nakamura', email: 'james.nakamura@email.com', phone: '250-555-0106', status: 'Current', unitId: 'u7', role: 'MEMBER', startDate: '2017-05-20' },
  { id: 't7', firstName: 'Linda', lastName: 'Nakamura', email: 'linda.nakamura@email.com', phone: '250-555-0107', status: 'Current', unitId: 'u8', role: 'MEMBER', startDate: '2017-05-20' },
  { id: 't8', firstName: 'Carlos', lastName: 'Rivera', email: 'carlos.rivera@email.com', phone: '250-555-0108', status: 'Current', unitId: 'u9', role: 'MEMBER', startDate: '2022-02-14' },
  { id: 't9', firstName: 'Aisha', lastName: 'Mohammed', email: 'aisha.mohammed@email.com', phone: '250-555-0109', status: 'Current', unitId: 'u10', role: 'MEMBER', startDate: '2021-08-30' },
  { id: 't10', firstName: 'Thomas', lastName: 'Bergstrom', email: 'thomas.bergstrom@email.com', phone: '250-555-0110', status: 'Current', unitId: 'u11', role: 'ADMIN', startDate: '2016-11-01' },
  { id: 't11', firstName: 'Karen', lastName: 'Bergstrom', email: 'karen.bergstrom@email.com', phone: '250-555-0111', status: 'Current', unitId: 'u12', role: 'MEMBER', startDate: '2016-11-01' },
  { id: 't12', firstName: 'Wei', lastName: 'Liu', email: 'wei.liu@email.com', phone: '250-555-0112', status: 'Current', unitId: 'u14', role: 'MEMBER', startDate: '2023-04-01' },
  { id: 't13', firstName: 'Patricia', lastName: 'MacLeod', email: 'patricia.macleod@email.com', phone: '250-555-0113', status: 'Current', unitId: 'u15', role: 'ADMIN', startDate: '2019-06-15' },
  { id: 't14', firstName: 'Kevin', lastName: 'MacLeod', email: 'kevin.macleod@email.com', phone: '250-555-0114', status: 'Current', unitId: 'u16', role: 'MEMBER', startDate: '2019-06-15' },
  { id: 't15', firstName: 'Fatima', lastName: 'Al-Hassan', email: 'fatima.alhassan@email.com', phone: '250-555-0115', status: 'Current', unitId: 'u17', role: 'ADMIN', startDate: '2020-10-01' },
  { id: 't16', firstName: 'George', lastName: 'Papadopoulos', email: 'george.papadopoulos@email.com', phone: '250-555-0116', status: 'Current', unitId: 'u18', role: 'ADMIN', startDate: '2015-03-01' },
  { id: 't17', firstName: 'Helen', lastName: 'Papadopoulos', email: 'helen.papadopoulos@email.com', phone: '250-555-0117', status: 'Current', unitId: 'u19', role: 'MEMBER', startDate: '2015-03-01' },
  { id: 't18', firstName: 'Michael', lastName: 'Johansson', email: 'michael.johansson@email.com', phone: '250-555-0118', status: 'Current', unitId: 'u20', role: 'MEMBER', startDate: '2022-09-01' },
