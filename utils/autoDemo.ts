...
export const AUTO_DEMO_STOPS: AutoDemoStop[] = [
  {
    ...
    keyCapability: 'New users get oriented before the tour starts, with enough context to understand how the main work areas fit together.',
    scrollMode: 'top',
  },
  {
    id: 'mission-control',
  ...
  },
  {
    ...
    keyCapability: 'Users can adapt the dashboard as the co-op grows, keeping the workspace focused on the role and task at hand.',
    scrollMode: 'target',
  },
  {
    ...
    body: 'Tiles are entry points, not static charts. The demo opens the next meeting from the dashboard so new users can see how summary information leads to the actual workflow.',
    keyCapability: 'This reduces hunting and helps board members move from "what is happening?" to "what do I do next?"',
  ...
  },
  {
    ...
    keyCapability: 'Residents and board members arrive informed, which makes participation easier and reduces back-and-forth questions.',
    scrollMode: 'top',
  },
  {
    id: 'event-attendance',
    ...
    keyCapability: 'Small collaboration cues like attendance help meetings feel less like paperwork and more like a shared community habit.',
    scrollMode: 'target',
  },
  {
    id: 'open-calendar',
  ...
  },
  {
    ...
    body: 'The demo pauses on Event Details first so new users can see the meeting description, date, location, attendance, and admin edit controls before moving into minutes.',
  ...
  },
  {
    ...
    keyCapability: 'Users can follow the practical path from calendar to meeting to archive, without duplicate filing work.',
  ...
  },
  {
    ...
    keyCapability: 'New users can see where the feature lives, so the wizard teaches the navigation path instead of teleporting between screens.',
  ...
  },
  {
    ...
    body: 'A request is not just a row in a table. The demo opens the work order so new users can see the whole maintenance record behind it.',
  ...
  },
  {
    ...
    keyCapability: 'Users can see how one object leads to the next: request, unit, resident, documents, and history.',
  ...
  },
  {
    ...
    body: 'The demo seeds a realistic Q&A about a leaking sink so new users can see the assistant answer from co-op context, cite records, and suggest the next action.',
