...
export const ANNOUNCEMENT_PRIORITY_OPTIONS = ['High', 'Medium', 'Low'] as const;

export const getAnnouncementPriorityFormOptions = () => [...ANNOUNCEMENT_PRIORITY_OPTIONS];

export const getAnnouncementPriorityFilterOptions = () => ['All', ...ANNOUNCEMENT_PRIORITY_OPTIONS];
